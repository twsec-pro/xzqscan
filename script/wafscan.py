...
'''
Author: twsec
Date: 2022-04-10 13:56:33
LastEditors: twsec
LastEditTime: 2022-04-10 14:30:11
Description: waf检测模块
'''
...
def scan_waf(url):
    urls = url + '%29%28%22%27 and 1=1 union select user from admin%23<script>alert(1)</script>'
    ...
    for k, v in waf_dic.items():
        for x in v:
            try:
                ...
                print("未能检测出WAF，可能不存在WAF!")
                pass

#print(scan_waf('http://www.xtxyz.com/show_list.php?id=79'))
